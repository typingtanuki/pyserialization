...
class TestBytesCodec(TestCodec):
    def test_type_check(self):
        codec: Codec[bytes] = BytesCodec(Codec.to_byte(12))
    ...
    def test_1b(self):
        ...
        writer: BufferedWriter = self.writer()
        codec.write(writer, Codec.to_byte(1))
        writer.close()

        reader: BufferedReader = self.reader()
        self.assertEqual(codec.read(reader), Codec.to_byte(1))
        reader.close()
    ...
    def test_123b(self):
        ...
        writer: BufferedWriter = self.writer()
        codec.write(writer, Codec.to_byte(123))
        writer.close()

        reader: BufferedReader = self.reader()
        self.assertEqual(codec.read(reader), Codec.to_byte(123))
        reader.close()
    ...
    def test_mix(self):
        ...
        writer: BufferedWriter = self.writer()
        codec.write(writer, Codec.to_byte(123))
        codec.write(writer, Codec.to_byte(255))
        codec.write(writer, Codec.to_byte(255))
        ...
        reader: BufferedReader = self.reader()
        self.assertEqual(codec.read(reader), Codec.to_byte(123))
        self.assertEqual(codec.read(reader), Codec.to_byte(255))
        self.assertEqual(codec.read(reader), Codec.to_byte(255))
